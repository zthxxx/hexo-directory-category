...
describe('Hexo-Directory-Category', function() {
  ...
  it('post - categories exist, plugin disable, should not change', function() {
  ...
  it('post - categories not exist, plugin disable, should not change', function() {
    let defaultEnable = hexo.config.auto_dir_categorize.enable;
    hexo.config.auto_dir_categorize.enable = false;
  ...
  it('post - categories exist, but empty, plugin disable, should be empty', function() {
    let defaultEnable = hexo.config.auto_dir_categorize.enable;
    hexo.config.auto_dir_categorize.enable = false;
  ...
  it('post - categories exist, but empty, should added categories with directories', function() {
  ...
  it('post - categories exist, should not change', function() {
    let body = [
      'title: "Vim note"',
      'categories: [CS, Usage]',
      '---'
  ...
  it('post - category not exist, should added categories with directories', function() {
    let body = [
      'title: "Vim note"',
      '---'
    ].join('\n');
  ...
  it('post - categories exist, but enable force, should overwrite with directories', function() {

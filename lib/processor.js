...
module.exports = function(ctx) {
  function processPost(file) {
    ...
    var autoDirClassify = config.auto_dir_categorize;
    var dirCategories = [];
    var categories, tags;
    ...
    return Promise.all([
      ...
      dirCategories = data.categories || [];
      if (autoDirClassify.enable) {
        dirCategories = pathFn.relative('_posts',pathFn.dirname(data.source)).split(pathFn.sep);
        if (!autoDirClassify.force) dirCategories = data.categories || dirCategories;
      }
